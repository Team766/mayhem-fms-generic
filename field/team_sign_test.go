...
func TestTeamSign_GenerateInMatchRearText(t *testing.T) {
	...
	assert.Equal(t, "01:23 R012-B040 ", generateInMatchTeamRearText(arena, true, "01:23"))
	assert.Equal(t, "01:23 B040-R012 ", generateInMatchTeamRearText(arena, false, "01:23"))
	assert.Equal(t, "00:59 R012-B040 ", generateInMatchTeamRearText(arena, true, "00:59"))
	assert.Equal(t, "00:59 B040-R012 ", generateInMatchTeamRearText(arena, false, "00:59"))

	// Check that RP progress is hidden for playoff matches.
	arena.CurrentMatch.Type = model.Playoff
	assert.Equal(t, "00:45 R012-B040 ", generateInMatchTeamRearText(arena, true, "00:45"))
	assert.Equal(t, "00:45 B040-R012 ", generateInMatchTeamRearText(arena, false, "00:45"))
}
