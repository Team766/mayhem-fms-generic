...
// Rules that carry over from season to season (see specs/GENERAL_RULES.md). A game adds its own rules to this list.
// @formatter:off
var rules = []*Rule{
	...
	{16, "G413", true, false, "A ROBOT may not extend beyond the horizontal or vertical expansion limits set by the robot rules."},
