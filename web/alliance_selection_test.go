...
func TestAllianceSelectionFinalizeSingleEliminationSingleGame(t *testing.T) {
	web := setupTestWeb(t)
...
func TestAllianceSelectionFinalizeSingleEliminationSingleGameTwoVsTwo(t *testing.T) {
	web := setupTestWeb(t)
